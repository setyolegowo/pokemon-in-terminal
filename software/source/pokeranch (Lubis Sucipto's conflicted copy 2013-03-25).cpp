...
void PokeRanch::BattleWild(unsigned char *result)
{
            ...
            do {
                ...
                if(command_respon > 0) {
                    if(command_respon == 3) {
                        ...
                        item_num_use = listItem.IsOnTable(item_use);
                        if((item_num_use > 0) && (item_num_use != 17) && (item_num_use < 8) && (item_num_use > 11)) { AcceptCR = true; command_respon = 255; }
                        else {
                            AcceptCR = false;
                            command_respon = 0;
                        }
                    // } else if(command_respon == 23) {
                        // // Change party <-- Cek change ke mana
                        // if(Trainer.TotalMonster() > 1) {
                            // AcceptCR = true;
                            // command_respon = 255;
                        // } else {
                            // AcceptCR = false;
                        ...
                        if(command_respon == 22) { // Jika mengunakan item
                            if((item_num_use >= 1) && (item_num_use <= 3)) {
                                ...
                                if(((100*(3*WildMonster.HPMax - 2*WildMonster.HP)*(rand() % 10)/7)/(3*WildMonster.HPMax*item_num_use)) < 20) {
                                    ...
                                    cout << "\n\t--> Gagal menangkap monster"; input_manager::delay(1);
                                }
                            }
                        } else if(command_respon == 23) { // Jika mengganti ## BELUM
                            ...
                            if(int(double(UseSkill.GetAccuracy() + (((rand() % 20) + 96)/100))*ActiveMonster.Acc) > 100) {
                                ...
                                cout << "\n\t--> Gagal menggunakan skill " << listSkill.GetNameSkillFromNumberSkill(PlayerMonster1.getSkill(SkillUsePlayer)); input_manager::delay(2);
                            }
                        }
                    }
                    // Wild Monster Phase
    ...
    if(WildMonster.HP == 0) {
        ...
        cout << " Berhasil mengalahkan monster liar.\n"; input_manager::delay(1);
        cout << " Anda mendapatkan " << Money << " Zeny dan " << Exp << " Exp.\n"; input_manager::delay(1);
