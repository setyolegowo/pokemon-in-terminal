...
class PlayerMonster: public Monster
{
    private:
        ...
        unsigned int CurExp;
		unsigned int ExpMax; // gak usah
        unsigned int TotalExp; // gak usah
        unsigned int IncHP;
        unsigned int HP; // jadi curHP
        unsigned int IncAttack;
		unsigned int Attack; // gak usah
        unsigned int IncDefense;
		unsigned int Defense; // gak usah
        unsigned int IncSpeed;
		unsigned int Speed; // gak usah
        int* Skills; // Dipisah jadi NoSkill1-NoSkill4
        int* PPOfSkills; // Dipisah jadi PP1-PP4
        int StatusEffect; // Jadi NoStatusEffect
		char NameOfStatusEffect[11]; // Gak usah
    public:
        PlayerMonster();
